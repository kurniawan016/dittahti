...
import Barang from '../components/barangterbaru.vue'
</script>
    ...
    <div class="p-2 lg:p-4 lg:flex lg:gap-4">
      <a href="/bselengkapnya" class="w-full rounded-md shadow-lg bg-slate-200 h-44">
        <div class="gap-4 p-2 lg:flex">
          <img class="w-full h-56 rounded-md lg:h-40 lg:w-44" src="https://cdn.antaranews.com/cache/800x533/2019/07/22/ungkap-narkoba.jpg" alt="">
          <div>
...
<script>
// Tidak ada kode yang perlu ditambahkan di sini
</script>
