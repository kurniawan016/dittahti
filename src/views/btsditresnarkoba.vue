...
<form class="flex items-end">   
    ...
    <button type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-cyan-800 rounded-lg border border-white hover:bg-cyan-400 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
<div class="w-48 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
    ...
    <a href="/btsditresnarkoba" class="block w-full px-4 py-2 text-white border-b border-gray-200 cursor-pointer bg-gradient-to-br from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gray-100 focus:outline-none focus:ring-2 dark:border-gray-600 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-500 dark:focus:text-white">
        DITRESNARKOBA
    </a>
    <a href="/btsditpolairud" class="block w-full px-4 py-2 border-b border-gray-200 cursor-pointer hover:bg-gray-100 focus:outline-none focus:ring-2 dark:border-gray-600 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-500 dark:focus:text-white">
        DITPOLAIRUD
    </a>
</div>
    ...
    <div class="w-full">
      <div class="grid grid-cols-4 gap-4 p-4">
        <div class="h-64 p-1 mb-2 border border-blue-400 rounded-md">
          ...
          <div class="w-full">
            <p class="text-xs text-gray-400" for="">DAFTAR BARANG TEMUAN</p>
          </div>
...
<nav aria-label="Page navigation example">
  ...
  <!-- Main modal -->
<div id="defaultModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-2 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
